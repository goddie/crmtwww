					...
					<div class="col-lg-12">
						...
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form
									action="${pageContext.request.contextPath}/submit/action/add"
									name="form1" method="post" class="form-horizontal">
									<input name="topType" value="${topType }" type="hidden" />  
										<input
										name="submitId" value="${submitId }" type="hidden" />
									<fieldset>
										...
										<div class="form-group">
											<label class="col-lg-2 control-label"
												for="textarea-wysihtml5">投稿内容</label>
											<div class="col-lg-10">

												<textarea id="ckeditor_full" name="content"
													class="form-control textarea-wysihtml5"
													placeholder="输入正文...">${submit.content }</textarea>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input name="tel" value="${submit.tel }" type="text" class="form-control col-md-6" />
