	...
	a.fn.slide = function(b) {
		return a.fn.slide.defaults = {
			...
			case "top":
				...
				break;
			case "left":
				j.wrap('<div class="tempWrap" style="overflow:hidden; width:"100%"; position:relative; width:' + s * y + 'px"></div>').css({
					width: k * y,
					position: "relative",
					overflow: "hidden",
					padding: "0",
			...
			case "leftLoop":
			case "leftMarquee":
				j.children().clone().appendTo(j).clone().prependTo(j), j.wrap('<div class="tempWrap" style="overflow:hidden; width:"100%"; position:relative; width:' + s * y + 'px"></div>').css({
					width: 3 * k * y,
					position: "relative",
					overflow: "hidden",
					padding: "0",
