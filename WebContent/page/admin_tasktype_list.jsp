					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="text-muted bootstrap-admin-box-title">任务分类列表</div>
										...
										<tbody role="alert" aria-live="polite" aria-relevant="all">
											...
											<c:forEach var="m" varStatus="status" items="${list}">
												...
												<tr class="gradeA odd">
													...
													<td class="">${m.name}</td>
													<td class="" title="${m.parent.id}">${m.parent.name}</td>
													<td class="">${m.id}</td>
													<td class="action"><a
														href="${pageContext.request.contextPath}/tasktype/action/del?id=${m.id}">
															删除 </a></td>
												</tr>
											</c:forEach>
										</tbody>
