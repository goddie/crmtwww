										...
										<tbody role="alert" aria-live="polite" aria-relevant="all">
											...
											<c:forEach var="m" varStatus="status" items="${list}">
												...
												<tr class="gradeA odd">
													...
													<td class=""><a href="${pageContext.request.contextPath}/article/detail?id=${m.id}" target="_blank">${m.title}</a></td>
													<td class=""><span title="${m.type.id }">${m.type.name}</span>/<span title="${m.subType.id }">${m.subType.name}</span></td>
